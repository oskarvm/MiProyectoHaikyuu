 ...
 * Use the {@link crearEquipo#newInstance} factory method to
...
public class crearEquipo extends Fragment {
    ...
    public static crearEquipo newInstance(String param1, String param2) {
        crearEquipo fragment = new crearEquipo();
